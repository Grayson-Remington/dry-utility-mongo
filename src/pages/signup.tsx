          ...
          <form className='mt-10' onSubmit={handleSubmit}>
            ...
            {password && !isPasswordValid(password) && (
              <p className='text-red-500'>
                Password must have at least 8 characters, contain a special
                character, a number, and an uppercase and lowercase letter.
              </p>
            )}
            <button
              type='submit'
            ...
            <div className='sm:flex sm:flex-wrap mt-8 sm:mb-4 text-sm text-center items-center justify-center'>
              <p className='mx-2 flex-2'>Already have an account? </p>
              <Link href='/signin' className='flex-2 underline'>
                Login
              </Link>
            </div>
          </form>
